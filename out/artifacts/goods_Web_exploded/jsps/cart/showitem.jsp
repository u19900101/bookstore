...
/*  function CreateOrderByIds(){
	...
	location="/goods/OrderServlet?method=CreateOrder&orderItemIds="+orderItemIds+"&total="+total;
}  */
</script>
  </head>
  
  <body>
<form id="form1" action="<c:url value='/order/CreateOrder.action?total=${total}&orderItemIds=${orderItemIds}'/>" method="post">
	...
	<c:forEach items="${cartItemList}" var ="cartItem">
		<tr align="center">
			...
			<input type="hidden" class="cartItemIds" id="cartItemIds" value="${cartItem.cartitemid}"/>
		...
		<tr>
			<td colspan="6">
				<input id="address" type="text" name="address" value="北京市 昌平区 西三旗 金燕龙办公楼1层 传智播客 张三爷"/>
			</td>
		</tr>
		
		<tr>
			<td style="border-top-width: 4px;" colspan="5" align="right">
				<a id="linkSubmit" href="javascript:$('#form1').submit();">生成订单</a>
			</td>
		</tr>
	</table>
	</form>
